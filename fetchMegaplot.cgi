...
print( "<EM>Source data not updated regularly.</EM><BR>" );



# Links for standard plots
my $link = sprintf( "%s?filePlot=%s", $webStartPage, "fig--megaplot3--lastSixMonths.png" );
print $q->a({href=>$link}, "Last 6 months" );
print( "$tab1" );
$link = sprintf( "%s?filePlot=%s", $webStartPage, "fig--megaplot3--lastYear.png" );
print $q->a({href=>$link}, "Last year" );
print( "$tab1" );
$link = sprintf( "%s?filePlot=%s", $webStartPage, "fig--megaplot3--lastTwoYears.png" );
print $q->a({href=>$link}, "Last two years" );
print( "$tab1" );
$link = sprintf( "%s?filePlot=%s", $webStartPage, "fig--megaplot3--lastFiveYears.png" );
print $q->a({href=>$link}, "Last five years" );
print( "$tab1" );
$link = sprintf( "%s?filePlot=%s", $webStartPage, "fig--megaplot3--pause5.png" );
print $q->a({href=>$link}, "Pause 5" );
print( "$tab1" );
$link = sprintf( "%s?filePlot=%s", $webStartPage, "fig--megaplot3--wholeEruption.png" );
print $q->a({href=>$link}, "Whole eruption" );
print $q->br();



# Test for filePlot in parameters, if not there, set default
my $filePlot= $q->param('filePlot');
if ( not defined $filePlot) {
	$filePlot = 'fig--megaplot3--wholeEruption.png';
}


# Test for plotDuration in parameters
my $plotDuration = $q->param('plotDuration');
if( defined $plotDuration ){
    sleep( 180 );
    ...
    $filePlot = join( '/', $dirPlot, $filePlot );
    ...
    print("$tab1 <EM>There is a three-minute delay while the plot is generated, and nothing to tell you if you have submitted the request. If you get the wrong plot, refresh the page and wait another three minutes.</EM><BR>" );
